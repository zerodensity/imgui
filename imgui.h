...
namespace ImGui
{
    ...
    IMGUI_API bool          InputText2(const char* label, char* buf, size_t buf_size, int precision, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    IMGUI_API bool          InputText3(const char* label, char* buf, size_t buf_size, int precision, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    ...
    IMGUI_API bool          InputDoubleEx(const char* label, double* v, int precision, const char* format = "%.3f", ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputDouble2(const char* label, double* v, double step = 0.0, double step_fast = 0.0, const char* format = "%.6f", ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0);
    IMGUI_API bool          InputScalarEx(const char* label, ImGuiDataType data_type, void* p_data, int precision, const char* format = NULL, ImGuiInputTextFlags flags = 0);
